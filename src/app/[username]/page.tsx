...
const Profile = () => {
    ...
    const getUser = async () => {
        const user = await customFetch(
            `api/users/getUser/${params.username}`,
            "GET"
        );
    ...
    const renderData = () => {
        if (isLoading) {
            ...
            if (!user) {
                ...
                return (
                    <div className="xl:px-[50px] lg:px-[40px] md:px-[30px] sm:px-[40px] mt-3 xl:mt-10 lg:mt-8 md:mt-6 sm:mt-5 watchingHistoryWrapper">
                        ...
                        <WatchingHistoryBlock
                            watchingHistory={user.currentlyWatchingAnime!}
                        />
                        <Section
                            inWishList={true}
